...
if (!String.prototype.containsIgnoreCap) {
  String.prototype.containsIgnoreCap = function(searchString, startIdx) {
    startIdx = typeof startIdx !== 'undefined' ? startIdx : 0;
    if (this == null) {
      throw new TypeError('String.prototype.containsIgnoreCap called on null or undefined');
    }
